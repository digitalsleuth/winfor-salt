...
{% set shortcuts = [('Acquisition and Analysis', ['FEX Cloud Capture','FEX Imager','FIT','FTK Imager','Active@ Disk Editor\Active@ Disk Editor','Arsenal Image Mounter','Autopsy\Autopsy 4.22.0','gkape','Magnet ACQUIRE\Magnet ACQUIRE','Magnet Chromebook Acquisition Assistant v1\Magnet Chromebook Acquisition Assistant v1','Magnet Web Page Saver Portable V3','OSFMount\OSFMount','Tableau\Tableau Imager\Tableau Imager','X-Ways']),
                    ...
                    ('Document Analysis', ['ExifTool GUI','OffVis','MS Word Parser','PDFStreamDumper\PdfStreamDumper.exe','PDFXplorer','SSView']),
                    ...
                    ('Email', ['Aid4Mail 6\Aid4Mail6','EHB','Email Header Analyzer - Web Based','Kernel Exchange EDB Viewer\Kernel Exchange EDB Viewer','Kernel OST Viewer\Kernel OST Viewer','Kernel Outlook PST Viewer\Kernel Outlook PST Viewer','MailView','PST Walker Software\MSG Viewer','SysTools Outlook PST Viewer\SysTools Outlook PST Viewer','BitRecover EML Viewer',"4n6 Software\\4n6 Email Forensics Wizard",'PST Walker Software\PST Walker']),
                    ...
                    ('Network', ['Burp Suite Community Edition\Burp Suite Community Edition','Cyotek WebCopy\WebCopy','Fiddler Classic','IHB','NetScanner','NetworkMiner','Paessler Network Tools\Paessler SNMP Tester','PuTTY (64-bit)\PSFTP','PuTTY (64-bit)\PuTTY','WinHTTrack\WinHTTrack Website Copier','WinSCP','Wireshark','Zui']),
